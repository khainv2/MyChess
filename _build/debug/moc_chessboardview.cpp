...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ChessBoardView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ChessBoardView_t qt_meta_stringdata_ChessBoardView = {
    {
QT_MOC_LITERAL(0, 0, 14), // "ChessBoardView"
QT_MOC_LITERAL(1, 15, 12), // "boardChanged"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "ChessBoardView\0boardChanged\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_ChessBoardView[] = {
...
void ChessBoardView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ChessBoardView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChessBoardView::boardChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ChessBoardView::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ChessBoardView.data,
...
// SIGNAL 0
void ChessBoardView::boardChanged()
{
