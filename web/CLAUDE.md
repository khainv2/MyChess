...
```bash
node /home/youruser/MyChess/web/test_ws.js          # smoke 1 ván
```
...
Phải restart:
```bash
/home/youruser/MyChess/web/stop-bg.sh
/home/youruser/MyChess/web/run-bg.sh
tail -20 /home/youruser/MyChess/web/logs/server.log
```

### Sửa engine (`algorithm/*.cpp`, `uci_main.cpp`)
Rebuild standalone + restart server (vì process engine được spawn từ binary):
```bash
make -f /home/youruser/MyChess/Makefile.uci
/home/youruser/MyChess/web/stop-bg.sh
/home/youruser/MyChess/web/run-bg.sh
```
Smoke test engine trước khi qua web:
```bash
printf 'uci\nposition startpos\ngo movetime 500\n' | /home/youruser/MyChess/_build_uci_nodeps/MyChessUCI | tail -5
```
